...
game.States.play = function() {
    this.create = function() {
        ...
        game.time.events.loop(175000 / this.gameSpeed, this.generatePipes, this);
    ...
    this.generatePipes = function() { //制造管道
        this.gap = 50; //上下管道之间的间隙宽度
        var gap = this.gap;
