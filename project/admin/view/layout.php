...
<head>
    <meta charset="utf-8"/>
    <title>
        <?= isset($title) ? $title : '标题'; ?>
    </title>
    <meta content="alerts" name="description"/>
    ...
    <!--Beyond styles-->
    <link href="/assets/css/beyond.min.css" id="beyond-link" rel="stylesheet"/>
...
<body>
                ...
                <div class="navbar-header pull-right">
                    <div class="navbar-account">
                        <ul class="account-area">
                            ...
                            <li>
                                <a class="login-area dropdown-toggle" data-toggle="dropdown" style="width: 186px;">
                                    <div class="avatar" title="View your public profile">
                                        <img src="/assets/img/avatars/adam-jansen.jpg">
                                    </div>
                                    <section>
                                        <h2><span class="profile"><span><?= $_SESSION['admin']['login']; ?></span></span></h2>
                                    </section>
                                </a>
                                <!--Login Area Dropdown-->
                            ...
                            <label>
                                ...
                                <span class="text">固定顶部导航</span>
                            </label>
                            <label>
                                <input type="checkbox" id="checkbox_fixedsidebar">
                                <span class="text">固定侧边栏</span>
                            </label>
                            <!-- <label>
    ...
    <div class="main-container container-fluid">
        ...
        <div class="page-sidebar" id="sidebar">
            ...
            <?php foreach ($sidebar as $value): ?>
                <!--UI Elements-->
                <li<?php if ($value['is_active']): ?> class="active open"<?php endif ?>>
                    ...
                    <ul class="submenu">
                    <?php foreach ($value['menu'] as $v): ?>
                        <li<?php if ($v['is_active']): ?> class="active"<?php endif ?>>
        ...
        <!-- /Page Sidebar -->
            ...
            <div class="page-content">
                ...
                <!-- Page Body -->
                <div class="page-body">
                <?php require self::viewPath(self::$layout_string);?>
                </div>
                <!-- /Page Body -->
            </div>
            <!-- /Page Content -->
    ...
    <script src="/assets/js/toastr/toastr.js">
    </script>
