					...
					<tbody>
						<?php foreach ($cate as $value): ?>
							<tr>
								...
								<td>
									<a href="javascript:void(0);" class="btn btn-info btn-xs edit" data-id="<?= $value['id']; ?>" data-name="<?= $value['name']; ?>" data-parent="<?= $value['parent_id']; ?>"><i class="fa fa-edit"></i> 编辑</a>
